...
for phi in phi_values:
    ...
    I = accessible_area_inside.area if accessible_area_inside.area > 1e-10 else 0.0
...
plt.ylabel("Accessibility I (normalized)")
plt.title("Accessibility I vs Pac-Man Mouth Angle φ")
plt.grid(True)
plt.show()
